...
#ifndef VL_HAVE_CONST_W_20X
# define VL_HAVE_CONST_W_20X
static inline WDataOutP VL_CONST_W_20X(int obits, WDataOutP o
    	,IData d19,IData d18,IData d17,IData d16
        ...
        o[19]=d19; o[18]=d18; o[17]=d17; o[16]=d16;
        ...
        for(int i=20;i<VL_WORDS_I(obits);i++) o[i] = (IData)0x0;
        return o;
}
#endif
