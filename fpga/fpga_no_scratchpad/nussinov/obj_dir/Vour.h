...
VL_MODULE(Vour) {
  public:
    ...
    VL_SIG16(our__DOT__saddr0,11,0);
    VL_SIG16(our__DOT__saddr1,11,0);
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    VL_SIG8(__Vdly__our__DOT__r_we1,0,0);
    ...
    //char	__VpadToAlign329[1];
    VL_SIG16(__Vdly__our__DOT__saddr0,11,0);
    VL_SIG16(__Vdly__our__DOT__saddr1,11,0);
    //char	__VpadToAlign334[2];
    VL_SIG(__Vdly__our__DOT__r_d1,31,0);
    VL_SIG(__Vdly__our__DOT__r_d0,31,0);
    VL_SIG(__Vdly__our__DOT__kernel__DOT__j_0_in_reg_184,31,0);
    VL_SIG(__Vdly__our__DOT__kernel__DOT__i_cast_reg_597,31,0);
    VL_SIG(__Vdly__our__DOT__kernel__DOT__tmp_36_cast2_reg_632,31,0);
  ...
  public:
    ...
    static void	_initial__TOP__5(Vour__Syms* __restrict vlSymsp);
    static void	_multiclk__TOP__8(Vour__Syms* __restrict vlSymsp);
