...
VL_MODULE(Vour) {
  public:
    ...
    VL_SIG8(__VinpClk__TOP__our__DOT__r_k_clk,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__our__DOT__r_k_clk,0,0);
    VL_SIG8(__Vclklast__TOP__clk,0,0);
    VL_SIG8(__Vchglast__TOP__our__DOT__r_k_clk,0,0);
    //char	__VpadToAlign16713[3];
