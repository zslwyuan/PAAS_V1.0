...
VL_INLINE_OPT void Vour::_sequent__TOP__1(Vour__Syms* __restrict vlSymsp) {
    ...
    Vour* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
	= vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184;
    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 
	= vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194;
    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__i_reg_172 
	= vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172;
    // ALWAYS at kernel_nussinov.v:736
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612 
	= (VL_ULL(0x7fffffffc0) & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612);
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612 
	= (VL_ULL(0x3fffffffff) & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612);
    // ALWAYS at kernel_nussinov.v:244
    if ((1U & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
		>> 0xaU) & (~ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_26_fu_532_p2))))) {
	vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
	    = vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642;
    } else {
	if ((1U & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
		    >> 1U) & (~ ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172) 
				 >> 6U))))) {
	    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
		= VL_EXTENDS_II(32,7, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172));
	}
    }
    // ALWAYS at kernel_nussinov.v:252
    if ((0x2000U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 
	    = vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_reg_757;
    } else {
	if ((0x200U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 
		= vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_cast_reg_597;
	}
    }
    // ALWAYS at kernel_nussinov.v:236
    if (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	 & (IData)(vlTOPp->our__DOT__kk__DOT__r_next))) {
	vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__i_reg_172 = 0x3eU;
    } else {
	if ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	      >> 2U) & (0x3eU == vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184))) {
	    vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__i_reg_172 
		= vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_1_fu_337_p2;
	}
    }
    // ALWAYS at kernel_nussinov.v:280
    if ((0x400U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_reg_757 
	    = ((IData)(1U) + vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194);
    }
}
...
VL_INLINE_OPT void Vour::_sequent__TOP__2(Vour__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->__Vdly__our__DOT__kk__DOT__r_q0 = vlTOPp->our__DOT__kk__DOT__r_q0;
	...
	if (((VL_ULL(0xb) == vlTOPp->our__DOT__kk__DOT__state) 
		...
		if ((VL_ULL(2) == vlTOPp->our__DOT__kk__DOT__state)) {
			...
			vlTOPp->__Vdly__our__DOT__kk__DOT__r_q0 
...
VL_INLINE_OPT void Vour::_sequent__TOP__5(Vour__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->our__DOT__kk__DOT__r_d1 = (VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__r_q1, vlTOPp->our__DOT__kk__DOT__r_q0)
				        ? vlTOPp->our__DOT__kk__DOT__r_q0
				        : vlTOPp->our__DOT__kk__DOT__r_q1);
    // ALWAYS at kernel.v:139
    vlTOPp->our__DOT__kk__DOT__r_we1 = (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
					 >> 5U) & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_3_reg_627));
    // ALWAYS at kernel.v:137
    vlTOPp->our__DOT__kk__DOT__r_we0 = (1U & ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						>> 0xdU) 
					       | (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						   >> 3U) 
						  & (~ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_13_reg_655)))) 
					      | (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						  >> 9U) 
						 & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_reg_689))));
    ...
    vlTOPp->our__DOT__kk__DOT__r_ce0 = (1U & ((((((
						  ...
						  | (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						      >> 7U) 
						     & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693))) 
						 | (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						     >> 7U) 
						    & (~ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693)))) 
						| ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
    ...
    vlTOPp->our__DOT__kk__DOT__r_d0 = ((0x2000U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
				        ? vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_32_reg_785
				        : ((0x200U 
					    & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
					    ? ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693)
					        ? (
						   VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__r_q1, vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_18_reg_735)
						    ? vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_18_reg_735
						    : vlTOPp->our__DOT__kk__DOT__r_q1)
					        : vlTOPp->our__DOT__kk__DOT__r_q1)
					    : ((8U 
						& (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
					        ? (
						   VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__r_q0, vlTOPp->our__DOT__kk__DOT__r_q1)
						    ? vlTOPp->our__DOT__kk__DOT__r_q1
						    : vlTOPp->our__DOT__kk__DOT__r_q0)
					        : 0U)));
    ...
    vlTOPp->our__DOT__kk__DOT__saddr0 = (0xfffU & (
						   (0x2000U 
						    & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						    ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_9_reg_751)
						    : 
						   ((0x800U 
						     & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						     ? (IData)(
							       VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_40_reg_765)))
						     : 
						    ((0x200U 
						      & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						      ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_5_reg_709)
						      : 
						     ((1U 
						       & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
							   >> 7U) 
							  & (~ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693))))
						       ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_fu_441_p2)
						       : 
						      ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
							 >> 7U) 
							& (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693))
						       ...
						       ((0x40U 
							 & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							 ? (IData)((QData)((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_35_reg_698)))
							 : 
							((0x10U 
							  & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							  ? (IData)(
								    VL_EXTENDS_QI(64,14, 
										(0x3fffU 
										& ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637) 
										+ vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642))))
							  : 
							 ((8U 
							   & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							   ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_1_reg_664)
							   : 
							  ((4U 
							    & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							    ? (IData)(
								      VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_20_fu_313_p2)))
							    : 0U))))))))));
    // ALWAYS at kernel.v:145
    vlTOPp->our__DOT__kk__DOT__saddr1 = (0xfffU & (
						   (0x800U 
						    & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						    ? (IData)(
							      VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_43_reg_770)))
						    : 
						   ((0x400U 
						     & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						     ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_9_reg_751)
						    ...
						    ((1U 
							 ...
							 & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
							    >> 8U)))
						      ? (IData)(
								(VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__r_q0, vlTOPp->our__DOT__kk__DOT__kernel__DOT__reg_203)
								  ? (QData)((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_35_reg_698))
								  : vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_reg_725))
						      : 
						     (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693) 
						       & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
							  >> 8U))
						      ...
						      ((0x40U 
							& (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
						        ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_reg_607)
						        : 
						       ((0x20U 
							 & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							 ? (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_3_reg_679)
							 : 
							((0x10U 
							  & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							  ? (IData)(
								    VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_27_fu_361_p2)))
							  : 
							 ((4U 
							   & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
							   ? (IData)((QData)((IData)(
										(0x3fffU 
										& ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617) 
										+ vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184)))))
							   : 0U)))))))));
    // ALWAYS at kernel_nussinov.v:286
    if ((0x20U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_reg_689 
	    = vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_fu_396_p2;
    }
    // ALWAYS at kernel_nussinov.v:292
    if ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	  >> 2U) & (0x3eU != vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__rev8_reg_659 
	    = (1U & (~ (vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
			>> 0x1fU)));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_13_reg_655 
	    = (1U & (vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
		     >> 0x1fU));
    }
    // ALWAYS at kernel_nussinov.v:354
    if ((0x1000U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_32_reg_785 
	    = (VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__kernel__DOT__reg_203, vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_30_fu_577_p2)
	        ? vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_30_fu_577_p2
	        : vlTOPp->our__DOT__kk__DOT__kernel__DOT__reg_203);
    }
    // ALWAYS at kernel_nussinov.v:348
    if (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693) 
	 & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	    >> 8U))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_18_reg_735 
	    = ((3U == (vlTOPp->our__DOT__kk__DOT__r_q0 
		       + vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_load_6_reg_720)) 
	       + vlTOPp->our__DOT__kk__DOT__kernel__DOT__reg_203);
    }
    ...
    if (((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	 ...
	 & (~ (vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
	       >> 0x1fU)))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_1_reg_664 
	    = (0xfffU & (IData)(VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_20_fu_313_p2))));
    }
    // ALWAYS at kernel_nussinov.v:741
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637 
	= (0x3fc0U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637 
	= (0x1fffU & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637));
    // ALWAYS at kernel_nussinov.v:305
    if ((0x10U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_3_reg_679 
	    = (0xfffU & (IData)(VL_EXTENDS_QI(64,14, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_27_fu_361_p2))));
    }
    // ALWAYS at kernel_nussinov.v:311
    if ((0x80U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_5_reg_709 
    ...
    if ((1U & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
		>> 7U) & (~ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693))))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_reg_725 
	    = vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_fu_441_p2;
    }
    // ALWAYS at kernel_nussinov.v:366
    if ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	  >> 0xaU) & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_26_fu_532_p2))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_40_reg_765 
	    = (0x3fffU & ((IData)(1U) + ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617) 
					 + vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194)));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_43_reg_770 
	    = (0x3fffU & ((0x3fc0U & (((IData)(2U) 
				       + vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194) 
				      << 6U)) + (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_37_reg_746)));
    }
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 
	= vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194;
    // ALWAYS at kernel_nussinov.v:260
    if ((0x800U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__reg_203 
	    = vlTOPp->our__DOT__kk__DOT__r_q1;
    } else {
	if ((0x80U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
    ...
    if ((0x200U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_9_reg_751 
	    = (0xfffU & (IData)(VL_EXTENDS_QI(64,14, 
					      (0x3fffU 
					       & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617) 
						  + vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642)))));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_37_reg_746 
	    = (0x3fffU & vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642);
    }
    // ALWAYS at kernel_nussinov.v:341
    if ((((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
	  >> 5U) & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_fu_396_p2))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693 
	    = VL_LTS_III(1,32,32, vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_cast_reg_597, vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184);
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_35_reg_698 
	    = (vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632 
	       + vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184);
    }
    // ALWAYS at kernel_nussinov.v:274
    if ((4U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642 
	    = ((IData)(1U) + vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184);
    }
    // ALWAYS at kernel_nussinov.v:738
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617 
	= (0x3fc0U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 
	= vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184;
    // ALWAYS at kernel_nussinov.v:268
    if ((2U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_cast_reg_597 
	    = VL_EXTENDS_II(32,7, (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172));
    }
    // ALWAYS at kernel_nussinov.v:739
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632 
	= (0xffffffc0U & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632);
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632 
	= (0x1fffU & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632);
    // ALWAYS at kernel_nussinov.v:324
    if ((1U & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
		>> 1U) & (~ ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172) 
			     >> 6U))))) {
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__table_addr_reg_607 
	    = (0xfffU & VL_EXTENDS_II(12,7, (0x40U 
					     ^ (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172))));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612 
	    = ((VL_ULL(0x400000003f) & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612) 
		  ...
		  << 6U));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617 
	    = ((0x3fU & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617)) 
	       | (0x3fc0U & VL_EXTENDS_II(32,13, ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172) 
						  << 6U))));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632 
	    = ((0xffffe03fU & vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632) 
	       | (0x1fc0U & (((IData)(1U) + (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172)) 
			     << 6U)));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637 
	    = ((0x203fU & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637)) 
	       | (0x1fc0U & (((IData)(1U) + (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172)) 
			     << 6U)));
	vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_3_reg_627 
	    = (0x3fU != (0x7fU & ((IData)(1U) + (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172))));
    }
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_26_fu_532_p2 
	= VL_LTS_III(1,32,32, ((IData)(1U) + vlTOPp->our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194), vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642);
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172 
	= vlTOPp->__Vdly__our__DOT__kk__DOT__kernel__DOT__i_reg_172;
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_36_fu_441_p2 
	= (VL_ULL(0x7fffffffff) & (vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612 
				   + (QData)((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642))));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_20_fu_313_p2 
	= (0x3fffU & ((IData)(1U) + ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617) 
				     + vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184)));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_27_fu_361_p2 
	= (0x3fffU & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617) 
		      + vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_reg_642));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_1_fu_337_p2 
	= (0x7fU & ((IData)(0x7fU) + (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172)));
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_fu_396_p2 
	= ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_3_reg_627) 
	   & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__rev8_reg_659));
    // ALWAYS at kernel_nussinov.v:228
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm 
	= ((IData)(vlTOPp->our__DOT__r_k_reset) ? 1U
	    : (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_NS_fsm));
}
...
VL_INLINE_OPT void Vour::_sequent__TOP__6(Vour__Syms* __restrict vlSymsp) {
    ...
    Vour* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->our__DOT__kk__DOT__r_q0 = vlTOPp->__Vdly__our__DOT__kk__DOT__r_q0;
...
VL_INLINE_OPT void Vour::_sequent__TOP__9(Vour__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->our__DOT__kk__DOT__next_out = (1U & (((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm) 
						  >> 1U) 
						 & ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172) 
						    >> 6U)));
}
...
void Vour::_settle__TOP__10(Vour__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_NS_fsm 
	= (((((((((1U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm)) 
		  | (2U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
		 | (4U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
		| (8U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
	       | (0x10U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
	      | (0x20U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
	     | (0x40U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))) 
	    | (0x80U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm)))
	    ? ((1U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
	        ? ((IData)(vlTOPp->our__DOT__kk__DOT__r_next)
		    ? 2U : 1U) : ((2U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
				   ? ((0x40U & (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__i_reg_172))
				       ? 1U : 4U) : 
				  ((4U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
				    ? ((0x3eU == vlTOPp->our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184)
				        ? 2U : 8U) : 
				   ((8U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
				     ? ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_3_reg_627)
					 ? 0x10U : 0x20U)
					 ...
					 ? 0x20U : 
					((0x20U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
					  ? ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__or_cond_fu_396_p2)
					      ? 0x40U
					      : 0x200U)
					  : ((0x40U 
					      == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
					      ? 0x80U
					      : 0x100U)))))))
	    : ((0x100U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
	        ? 0x200U : ((0x200U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
			     ? 0x400U : ((0x400U == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
					  ? ((IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__tmp_26_fu_532_p2)
					      ? 0x800U
					      : 4U)
					  : ((0x800U 
					      == (IData)(vlTOPp->our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm))
...
void Vour::_ctor_var_reset() {
    ...
    our__DOT__kk__DOT__saddr0 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__saddr1 = VL_RAND_RESET_I(12);
    ...
    our__DOT__kk__DOT__kernel__DOT__ap_CS_fsm = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__reg_203 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__i_cast_reg_597 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__table_addr_reg_607 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__kernel__DOT__tmp_34_cast3_reg_612 = VL_RAND_RESET_Q(39);
    our__DOT__kk__DOT__kernel__DOT__tmp_34_cast_reg_617 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__tmp_3_reg_627 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__tmp_36_cast2_reg_632 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_36_cast_reg_637 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__j_reg_642 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_13_reg_655 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__rev8_reg_659 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__table_addr_1_reg_664 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__kernel__DOT__i_1_fu_337_p2 = VL_RAND_RESET_I(7);
    our__DOT__kk__DOT__kernel__DOT__table_addr_3_reg_679 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__kernel__DOT__or_cond_fu_396_p2 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__or_cond_reg_689 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__tmp_12_reg_693 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__tmp_35_reg_698 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__table_addr_5_reg_709 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__kernel__DOT__table_load_6_reg_720 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_36_fu_441_p2 = VL_RAND_RESET_Q(39);
    our__DOT__kk__DOT__kernel__DOT__tmp_36_reg_725 = VL_RAND_RESET_Q(39);
    our__DOT__kk__DOT__kernel__DOT__tmp_18_reg_735 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_37_reg_746 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__table_addr_9_reg_751 = VL_RAND_RESET_I(12);
    our__DOT__kk__DOT__kernel__DOT__k_reg_757 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_40_reg_765 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__tmp_26_fu_532_p2 = VL_RAND_RESET_I(1);
    our__DOT__kk__DOT__kernel__DOT__tmp_43_reg_770 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__tmp_32_reg_785 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__i_reg_172 = VL_RAND_RESET_I(7);
    our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__tmp_20_fu_313_p2 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__tmp_27_fu_361_p2 = VL_RAND_RESET_I(14);
    our__DOT__kk__DOT__kernel__DOT__tmp_30_fu_577_p2 = VL_RAND_RESET_I(32);
    our__DOT__kk__DOT__kernel__DOT__ap_NS_fsm = VL_RAND_RESET_I(14);
    __Vdly__our__DOT__r_k_reset = VL_RAND_RESET_I(1);
    __Vdly__our__DOT__kk__DOT__r_q0 = VL_RAND_RESET_I(32);
    __Vdly__our__DOT__kk__DOT__r_q1 = VL_RAND_RESET_I(32);
    __Vdly__our__DOT__kk__DOT__kernel__DOT__i_reg_172 = VL_RAND_RESET_I(7);
    __Vdly__our__DOT__kk__DOT__kernel__DOT__j_0_in_reg_184 = VL_RAND_RESET_I(32);
    __Vdly__our__DOT__kk__DOT__kernel__DOT__k_0_in_reg_194 = VL_RAND_RESET_I(32);
