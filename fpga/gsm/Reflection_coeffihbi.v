...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module Reflection_coeffihbi_rom (
...
initial begin
    $readmemh("./Reflection_coeffihbi_rom.dat", ram0);
    $readmemh("./Reflection_coeffihbi_rom.dat", ram1);
end
...
Reflection_coeffihbi_rom Reflection_coeffihbi_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
