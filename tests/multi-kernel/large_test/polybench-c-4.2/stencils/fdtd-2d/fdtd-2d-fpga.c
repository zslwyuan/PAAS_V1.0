...
int main(int argc, char** argv)
{
 ...
 // POLYBENCH_1D_ARRAY_DECL(_fict_,DATA_TYPE,TMAX,tmax);
  ...
  //kernel_fdtd_2d (ex);
	...
	p0[6] = 0;
	p0[7] = 0;//Terminat
	p1 =(unsigned long long *) new((unsigned long long *)(p0+10)) unsigned long long[10];//Contro Port
	//printf("111111");
	p1[0] = 81;	
	p1[8] = 1;
	p1[3] = 9;//CurrentThreadID
	p1[4] = (3*NX+1)*NY;//Memory Range
	p1[5] = 4;//MemorySize
	p1[6] = 0;
	p1[7] = 0;//Terminat
	p2 =(unsigned long long *) new((unsigned long long *)(p1+10)) unsigned long long[10];//Contro Port
	//printf("111111");
	p2[0] = 81;	
	p2[8] = 1;
	p2[3] = 9;//CurrentThreadID
	p2[4] = (3*NX+1)*NY;//Memory Range
	p2[5] = 4;//MemorySize
	p2[6] = 0;
	p2[7] = 0;//Terminat
	p3 =(unsigned long long *) new((unsigned long long *)(p2+10)) unsigned long long[10];//Contro Port
	//printf("111111");
	p3[0] = 81;	
	p3[8] = 1;
	p3[3] = 9;//CurrentThreadID
	p3[4] = (3*NX+1)*NY;//Memory Range
	p3[5] = 4;//MemorySize
	p3[6] = 0;
	p3[7] = 0;//Terminat
    	p0[1] = (unsigned long long)u[0];//ReadBase
		p0[2] = (unsigned long long)u[0];//WriteBase
    	p1[1] = (unsigned long long)u[1];//ReadBase
		p1[2] = (unsigned long long)u[1];//WriteBase
    	p2[1] = (unsigned long long)u[2];//ReadBase
		p2[2] = (unsigned long long)u[2];//WriteBase
    	p3[1] = (unsigned long long)u[3];//ReadBase
		p3[2] = (unsigned long long)u[3];//WriteBase
		amo++;		
  		p0[6]=0;p0[6]=1;
		p1[6]=0;p1[6]=1;
		p2[6]=0;p2[6]=1;
		p3[6]=0;p3[6]=1;
while(p0[6]||p1[6]||p2[6]||p3[6]);
