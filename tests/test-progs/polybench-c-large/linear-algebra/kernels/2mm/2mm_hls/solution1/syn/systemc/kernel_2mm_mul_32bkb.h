...
#ifndef __kernel_2mm_mul_32bkb__HH__
#define __kernel_2mm_mul_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kernel_2mm_mul_32bkb) {
    ...
    SC_CTOR(kernel_2mm_mul_32bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
