...
static
void init_array (int n,long long A[N][N],long long B[N][N])
{
  int i, j;
...
static
void print_array(int n,long long A[N][N])
...
void kernel_jacobi_2d(long long A[2*N][N])
{
  int t, i, j;
  int tsteps=TSTEPS;
  int n=N;
...
int main(int argc, char** argv)
{
  ...
  /* Initialize array(s). */
  init_array (n, (long long (*)[N])A[0], (long long (*)[N])A[N]);
