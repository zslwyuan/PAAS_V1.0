...
system.fpga[1].ModuleName = 'FpgaModule1'

#Actually, if not in the full system mode, the TLBs are also supposed to be configured for the enforced mapping, but now take the default value
#
#for i in xrange(np):
#    system.cpu[i].dtb.size_control_fpga = 3221225472
#    system.cpu[i].dtb.fpga_bus_addr = 4096
#    system.cpu[i].dtb.baseaddress_control_fpga = 3221225472
