...
process1.pid = 1100;
process1.cmd = ['tests/test-progs/valid/valid']
...
system.fpga[0].ModuleName = 'valid/obj_dir/Vour'
system.fpga[0].reg_lat = '62ns'
system.cpu[0].workload = process1
system.cpu[0].createThreads()
system.piobus = IOXBar()
system.piobus.clk_domain = SrcClockDomain(clock = '25MHz') #options.fpga_clock/2)
system.piobus.clk_domain.voltage_domain = VoltageDomain()
system.piobus.width = 1.6
system.piobus.frontend_latency = 1
system.piobus.forward_latency = 1
system.piobus.response_latency = 1
