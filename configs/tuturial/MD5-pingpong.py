...
process1.pid = 1100;
process1.cmd = ['tests/test-progs/md5-pingpong/md5-fpga']
...
system.fpga[0].size_control_fpga = 30*8
system.fpga[0].ModuleName = 'MD5'
system.fpga[0].reg_lat=6

system.fpga[1].clk_domain = SrcClockDomain(clock = options.fpga_clock)
system.fpga[1].clk_domain.voltage_domain = VoltageDomain()
system.fpga[1].fpga_bus_addr = 1073741824*2 + 50*8
system.fpga[1].size_control_fpga = 30*8
system.fpga[1].ModuleName = 'MD5'
system.fpga[1].reg_lat=6

system.fpga[2].clk_domain = SrcClockDomain(clock = options.fpga_clock)
system.fpga[2].clk_domain.voltage_domain = VoltageDomain()
system.fpga[2].fpga_bus_addr = 1073741824*2 + 100*8
system.fpga[2].size_control_fpga = 30*8
system.fpga[2].ModuleName = 'MD5'
system.fpga[2].reg_lat=6

system.fpga[3].clk_domain = SrcClockDomain(clock = options.fpga_clock)
system.fpga[3].clk_domain.voltage_domain = VoltageDomain()
system.fpga[3].fpga_bus_addr = 1073741824*2 + 150*8
system.fpga[3].size_control_fpga = 30*8
system.fpga[3].ModuleName = 'MD5'
system.fpga[3].reg_lat=6
