...
system.cpu[1].cpu_id = 1;
system.cpu[1].clk_domain = SrcClockDomain(clock = '4MHz')
system.cpu[1].clk_domain.voltage_domain = VoltageDomain()
system.cpu[2].cpu_id = 2;
system.cpu[2].clk_domain = SrcClockDomain(clock = '3GHz')
system.cpu[2].clk_domain.voltage_domain = VoltageDomain()
system.cpu[1].num_input_fpga = 13;
system.cpu[1].num_output_fpga = 15;
...
system.cpu[2].icache_port = system.membus.slave
